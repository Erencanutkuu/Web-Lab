...
function App() {
  const [showUIKit, setShowUIKit] = useState(
    typeof window !== "undefined" && window.location.hash === "#uikit"
  );

  useEffect(() => {
    const onHashChange = () => {
      setShowUIKit(window.location.hash === "#uikit");
    };
  ...
  return (
    <>
        ...
        <section id="hakkimda" className="py-16 px-4">
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-8">
            <figure className="shrink-0">
              <img
                src="/profil.jpg"
                alt="Eren Can Utku vesikalik fotografi"
      ...
      <footer className="bg-gray-100 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 text-center py-6 px-4 text-gray-500 dark:text-gray-400 text-sm">
        <p>&copy; 2025 Eren Can Utku. Tum haklari saklidir.</p>
      </footer>
    </>
  );
}
